...
# informational briefs, and thinktank reports. The authors used text processing to find claims of attacks that included
# the words “collaboration,” “cooperation,” or “support.” The claims were all coded by hand to make sure that it really
# should be included. The claims came from US government translations of insurgent statements on social media.
...
# Note: sna and igraph share some function names that we will be using here, but the code will say
# igraph:: before the function.
...
network# Create a visual of the network.
